...
class Level:
    def __init__(self, screen, sound, dashboard, settings):
        ...
        self.image = pygame.image.load('img/level_bg.png')
    ...
    def loadLevel(self, levelname):
        ...
        with open("./levels/{}.json".format(levelname)) as jsonData:
            ...
            #instead of loadLayers and loadObjects, use the 1-1 background and scrolling
