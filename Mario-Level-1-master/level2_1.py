...
class Level1(tools._State):
    ...
    def setup_background(self):
        ...
        proportions"""
        self.background = setup.GFX['level2_1']
    ...
    def setup_ground(self):
        ...
        sprites to walk on"""
        ground_rect1 = collider.Collider(0, c.GROUND_HEIGHT - 108, 400, 60)
    ...
    def setup_pipes(self):
        ...
        pipe1 = collider.Collider(424, c.GROUND_HEIGHT - 148, 83, 82)
        pipe2 = collider.Collider(424, c.GROUND_HEIGHT - 188, 83, 82)
        pipe3 = collider.Collider(520, c.GROUND_HEIGHT - 400, 83, 500)
    ...
    def setup_mario(self):
        ...
        self.mario = mario.Mario(level2=True)
        self.mario.rect.x = self.viewport.x + 110
        self.mario.rect.bottom = c.GROUND_HEIGHT - 108
    ...
    def update(self, surface, keys, current_time):
        ...
        #print(self.mario.goToLevel2)
        if self.mario.goToLevel2 == True:
            self.end_game()
